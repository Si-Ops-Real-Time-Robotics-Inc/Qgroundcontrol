...
DECLARE_SETTINGSFACT(FlightMapSettings, rasterOverlayFile)
DECLARE_SETTINGSFACT(FlightMapSettings, rasterOverlayVisible)
DECLARE_SETTINGSFACT(FlightMapSettings, rasterOverlayOpacity)
